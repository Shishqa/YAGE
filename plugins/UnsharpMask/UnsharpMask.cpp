...
extern "C" PluginAPI::Plugin* get_plugin() {
    return PluginAPI::get_instance<UnsharpMask>();
}

/*----------------------------------------------------------------------------*/

bool ContrastPlugin::init() {
...
bool ContrastPlugin::deinit() { return true; }
...
void ContrastPlugin::start_apply(PluginAPI::Canvas canvas, PluginAPI::Position) {
...
void ContrastPlugin::apply(PluginAPI::Canvas, PluginAPI::Position) {}
void ContrastPlugin::stop_apply(PluginAPI::Canvas, PluginAPI::Position) {}
