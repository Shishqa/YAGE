...
void LayerList::update() {
    ...
    for (size_t layer = 0; layer < n_layers; ++layer) {
        ...
        button->applyStyle(
                Sh::ColorFill{Sh::Color(120, 120, 120)}, Sh::UIWindow::NORMAL,
                Sh::ColorFill{Sh::Color(200, 200, 200)}, Sh::UIWindow::HOVER,
                Sh::ColorFill{Sh::Color(230, 230, 230)}, Sh::UIWindow::SELECTED,
